...
function A = ABCs_recursion(in1, in2)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% ABCs of Recursion
%
...
X = max([in2,in1]);                      % First we need the maximum of the inputs to be X
Y = min([in2,in1]);                      % The minimum of the inputs needs to be Y
if (in1 == 0) || (in2 == 0) % Case when either input is zero
    A = X;                  % A corresponds to the maximum of the inputs
else
...
%% Part II: The recursive function
